            ...
            <Grid item xs={12} sm={12} md={9} lg={9} xl={9}>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    <Typography sx={{ fontSize: { xs: "11px", xl: "14px" } }}>Electronics</Typography>
                    <Typography
                      variant="h3"
                      sx={{ fontSize: { xs: "14px", xl: "20px" }, fontWeight: 600, mb: "0" }}
                    >
                      $35,000
                    </Typography>
                  </Box>
                ...
                >
                  ...
                  <Box>
                    <Typography sx={{ fontSize: { xs: "11px", xl: "14px" } }}>Clothing</Typography>
                    <Typography
                      variant="h3"
                      sx={{ fontSize: { xs: "14px", xl: "20px" }, fontWeight: 600, mb: "0" }}
                    >
                ...
                >
                  ...
                  <Box>
                    <Typography sx={{ fontSize: { xs: "11px", xl: "14px" } }}>Home Goods</Typography>
                    <Typography
                      variant="h3"
                      sx={{ fontSize: { xs: "14px", xl: "20px" }, fontWeight: 600, mb: "0" }}
                    >

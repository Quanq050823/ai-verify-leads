								...
								{(rowsPerPage > 0
									...
									<TableRow key={row.id}>
										...
										<TableCell
											...
											className="border-bottom"
										>
											<div className={`Sine-badge ${row.status}`}>
												{row.status}
											</div>
										</TableCell>

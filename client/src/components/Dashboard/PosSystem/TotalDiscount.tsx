      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/images/pos-system/total-discount-icon.svg"
          ...
          >
            <Box className="material-symbols-outlined fs-20 text-success-60" sx={{
            ...
            <span>
              <span style={{ fontWeight: 600}}>+8%</span> from last month
            </span>
          </Box>
        </Box>
      </Card>

...
const FeaturedPodcast: React.FC = () => {
  const [currentlyPlayingId, setCurrentlyPlayingId] = useState<number | null>(
    null
  );
  const [audioStates, setAudioStates] = useState<{ [id: number]: AudioState }>(
    {}
  );
            ...
            >
              <Grid item xs={12} sm={8} md={8} lg={8} xl={8}>
                ...
                >
                  ...
                  >
                    <Box sx={{ flexShrink: 0, fontSize: { xs: "24px", md: "28px" } }}>
                  ...
                  >
                    <Box sx={{ flexShrink: 0, fontSize: { xs: "24px", md: "28px" } }}>
                      <i
                        className="ri-thumb-up-line text-primary" 
                      ></i>
                    </Box>
                  ...
                  >
                    <Box sx={{ flexShrink: 0, fontSize: { xs: "24px", md: "28px" } }}>
                      <i
                        className="ri-bookmark-line text-primary" 
                      ></i>
                    </Box>
